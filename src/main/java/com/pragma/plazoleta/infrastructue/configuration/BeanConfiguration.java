...
public class BeanConfiguration {
    ...
    private final BeanFeignConfiguration beanFeignConfiguration;
    @Bean
    ...
    public IRestaurantServicePort restaurantServicePort() {
        return new RestaurantUseCase(restaurantPersistencePort(), beanFeignConfiguration.usuariosClient());
    }
}
