...
public class ValidateOrderWithEmployee implements IValidateOrderWithEmployee {
    ...
    @Override
    public OrderModel validate(String token, Long orderId, @Nullable String securityPin) {
        try {
            ...
            if(securityPin != null && !Objects.equals(securityPin, orderEntity.getSecurityPin()))
                throw new RequestException("security pin validation failed", HttpStatus.BAD_REQUEST);
